...
public class ActivityRepositoryStub implements ActivityRepository {
	...
	public List<Activity> findByDescription(List<String> description, int durationFrom, int durationTo) {
		...
		// select * from activities where description in(?,?,?) and durationFrom >? and duration To < ?
	...
	@Override
	public List<Activity> findConstraints(ActivitySearch search) {
	...
	/*@Override
	public User findUser(String activityId) {
